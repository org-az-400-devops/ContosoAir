[![Build Status](https://dev.azure.com/simonmacpherson/ContosoAir/_apis/build/status%2Forg-az-400-devops.ContosoAir?branchName=master)](https://dev.azure.com/simonmacpherson/ContosoAir/_build/latest?definitionId=12&branchName=master)
